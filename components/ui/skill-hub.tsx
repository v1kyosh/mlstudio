...
const NODES: HubNode[] = [
  { label: "Strategy", icon: Target, x: 50, y: 8 },
  { label: "Marketing", icon: Megaphone, x: 86.4, y: 29 },
  { label: "Ecommerce", icon: ShoppingCart, x: 86.4, y: 71 },
  { label: "AI Systems", icon: Sparkles, x: 50, y: 92 },
  { label: "Automation", icon: Workflow, x: 13.6, y: 71 },
  { label: "Brand & Design", icon: Palette, x: 13.6, y: 29 },
];
